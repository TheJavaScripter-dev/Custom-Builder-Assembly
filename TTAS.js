(function (Scratch) {
  ...
  class TTAS {
    ...
    getCompiler(bit, HEX) {
     ...
     this.COMPLIER.esp.push(A[i]);
     if (buffer[i]) {
      this.COMPLIER.ars.push(bit[i])
     } else {
      this.CACHE.REG[this.COMPLIER.ars[bit[i]]] = bit[i];
      this.COMPLIER.arg[bit[i]] = this.CACHE.REG[this.COMPLIER.ars[bit[i]]];
      this.CACHE.REG = {};
     }
     this.IT = []
     this.IT1 = []
     ...
     this.REST = buffer
      this.ALL = "TA/ sys"
      this.memorycode = {A: [], B: [], C: [], D: []}
      this.C = bit
      for (let j = 0; j < buffer.length; j++) {
        this.COMPLIER.eax.push(HEX[j]);
        this.IT.push(HEX[j]); this.COMPLIER.mov[HEX] = this.IT[j]
      }
      this.REST1 = {}
      this.OP = {}
    }
    ...
    getInfo() {
      return {
        id: 'typeturboassembly',
        name: 'Type Turbo Assembly Script',
        color1: '#3f1afa',
        blockIconURIa: 'data:image/png;base64,',
        blockIconURI: "data:image/png;base64,",
         blocks: [
...

          {
            opcode: "publicstat",
            blockType: Scratch.BlockType.CONDITIONAL,
            text: "public void [argumentslock]",
            arguments: {
              argumentslock: {type: Scratch.ArgumentType.STRING, defaultValue: ""}
            }
          },
  ...
  color1: "#8F508F"
...

        {
          ...
          { opcode: 'setVarC', blockType: Scratch.BlockType.COMMAND, text: 'int [NAME] = [VALUE]', arguments: { NAME: { type: Scratch.ArgumentType.STRING, defaultValue: "" }, VALUE: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 } }, color1f: "#FFAF00" },
          { opcode: 'getVarC', blockType: Scratch.BlockType.REPORTER, text: 'var [NAME]', arguments: { NAME: { type: Scratch.ArgumentType.STRING, defaultValue: 'foo' } }, color1f: "#FFAF00" },
          {
           opcode: "pointto",
           blockType: Scratch.BlockType.COMMAND,
           text: "*p [VALUE] = [VAR]",
           arguments: {
            VALUE: {type: Scratch.ArgumentType.STACK, defaultValue: ""},
            VAR: {type: Scratch.ArgumentType.STRING, defaultValue: "baz"}
           }
          },
          {
            opcode: "ref",
...
// ...
    ...
    },
    {
    ...
    },
     {
        opcode: "createarray",
        blockType: Scratch.BlockType.COMMAND,
        text: "array : [name] len [lengtha] typ [typearr]",
        arguments: {
          name: {type: Scratch.ArgumentType.STRING, defaultValue: "data"},
          lengtha: {type: Scratch.ArgumentType.NUMBER, defaultValue: 16},
              typearr: {type: Scratch.ArgumentType.STRING, defaultValue: "data"},
        } 
      },
      {
        opcode: "setitem",
        blockType: Scratch.BlockType.COMMAND,
        text: "set : [name] val [value] itm [item]",
        arguments: {
          name: {type: Scratch.ArgumentType.STRING, defaultValue: "data"},
          value: {type: Scratch.ArgumentType.NUMBER, defaultValue: 0},
         item: {type: Scratch.ArgumentType.NUMBER, defaultValue: 0},
        }
      },
      {
        opcode: "viewarray",
      ...
      },
      {
        ...
        blockType: Scratch.BlockType.REPORTER,
        blockShape: Scratch.BlockShape.SQUARE,
        text: "VIEW STORAGE [name] [select]",
        arguments: {
          name: {type: Scratch.ArgumentType.STRING, defaultValue: "data"},
          select: {type: Scratch.ArgumentType.STRING, menu: "menuarray", defaultValue: "STO_ARRAY"},
        }
      },
      {
        opcode: "deletearray",
        blockType: Scratch.BlockType.COMMAND,
        text: "delete array [arraya]",
        arguments: {
          arraya: {type: Scratch.ArgumentType.STRING, defaultValue: "data"}
        }
      },
        ],
        menus: {
    ...
    setVarC(args) { 
      this.STORAGE.vars[args.NAME] = this._tryParseValue(Number(args.VALUE));
     }
...
pointto(args) {
  this.STORAGE.vars[args.VAR] = args.VALUE;
  this.CACHE.REG[args.VAR] = this.STORAGE.vars[args.VAR]
}

ref(args) {
  return this.CACHE.REG[args.VAR];
}
...
booleanTA(args) {
  this.STORAGE.vars[args.VAR] = Boolean(args.VALUE)
}

publicstat(args){
const argument = args.argumentslock;
let key = "{" + argument + "}";
let json = JSON.parse(key);
let i = 0;
const lengths = Object.keys(json).length
for (i = 1; i <= lengths; i++) {
this.CACHE.IR[Object.keys(json)[i]] = [Object.values(json)[i]];
}
return true;
}

arg(args) {
  return this.CACHE.IR[args.NAME];
}

imaginary(args) {
  let imag = 1
  let value = Math.max(0, Math.E*0.1+Math.max(imag*1));
  if (imag = 1) {
   const imagin = value-Math.PI/180;
   let im = Math.sqrt(imagin-1+value);
   return [Math.floor(im), im, true, "i", "imaginary", "real=0"];
  }
}
...
this.Views[args.name] = new Int8Array(Array)
    ...
    setitem(args) {
      this.Views[args.name][args.item] = Number(args.value);
    }
    viewarray(args) {
      return this.Views[args.name][args.item];
    }
    storagearray(args) {
     if (args.select = "STO_ARRAY") {
      return this.Views[args.name].byteLength
     }
     if (args.select = "LENGTH_ARRAY") {
      return this.Views[args.name].length
     }
    }
    deletearray(args) {
